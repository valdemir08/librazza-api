...
class Livro:
    def __init__(self, titulo, edicao, editora, ano_publicacao, num_paginas, cod_barras, genero, disponivel, empresa_id, isbn, id=None):
        self.titulo = titulo
        self.edicao = edicao
    ...
    def get_values_save(self):
        return [self.titulo, self.edicao, self.editora, self.ano_publicacao, self.num_paginas, self.cod_barras, self.genero, self.disponivel, self.empresa_id, self.isbn]
